...
history = md.fit(x=X_train, y=y_train, batch_size=BATCH_SIZE, epochs=EPOCH, validation_data=(X_validation, y_validation))
...
#
# Add the callback object to the model.fit function